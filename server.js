...
// ref:https://forum.freecodecamp.org/t/authentication-with-socket-io-test-passing-but-the-terminal-log-is-not-logging-the-user-who-connected/434941/7
app.use(session({
...
myDB(async client => {
  ...
  io.on('connection', (socket) => {
    ...
    console.log('this is socket req user');
